...
def tabu_search(depot, clients, locations, vehicles, max_iterations=100, tabu_tenure=10):
    ...
    for vehicle in vehicles:
        ...
        while remaining_clients:
            ...
            if closest_client is None or demands[closest_client] > current_capacity or closest_distance > current_battery:
                # Retornar ao depósito para descarregar ou recarregar
        ...
        best_routes.append((vehicle, route, total_distance))
...
for depot, assigned_clients in assignments.items():
    ...
    routes = tabu_search(depot, assigned_clients, locations, depot_vehicles)
