...
def grasp_with_recharge(locations, demands, time_of_request, vehicle_capacity, battery_capacity_km, alpha=0.3, max_iterations=100):
    depot = "Depósito"
    best_route = None
    ...
    for _ in range(max_iterations):
        route, distance, time = construct_solution()
...
# Resolver o problema
final_route, total_distance, final_time = grasp_with_recharge(locations, demands, time_of_request, vehicle_capacity, battery_capacity_km)
