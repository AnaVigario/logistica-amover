...
def nearest_neighbor_with_recharge(locations, demands, time_of_request, vehicle_capacity, battery_capacity_km):
    depot = "Depósito"
...
# Resolver o problema
final_route, total_distance, final_time = nearest_neighbor_with_recharge(locations, demands, time_of_request, vehicle_capacity, battery_capacity_km)
