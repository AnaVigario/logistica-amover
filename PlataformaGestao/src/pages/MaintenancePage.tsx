      ...
      <div className="mb-6">
        <div className="relative">
          <input
            ...
            className="w-full bg-white rounded-md py-2 pl-10 pr-4 border"
                ...
                <div key={moto.id} className="border rounded-lg p-4">
                  <div className="flex justify-between items-start">
                    <div>
                      ...
                      <p className="text-sm text-gray-500">Motivo: {maint?.description}</p>
        ...
        <div className="space-y-3">
          {filteredMotorcycles
            ...
            .map((moto) => (
              <div
                key={moto.id}
                className="border p-4 rounded-lg cursor-pointer hover:border-gray-300"
            ...
            <div className="p-6">
              <div className="mb-6">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-sm text-gray-600">Está a enviar para manutenção:</span>
                </div>
          ...
          <div className="bg-white rounded-xl w-full max-w-md">
            ...
            <div className="p-6">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-sm text-gray-600">Está a remover da manutenção:</span>
              </div>
